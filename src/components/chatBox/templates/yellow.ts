...
#container {
  ...
  border: 2px solid rgba(255, 255, 70, 0.5);
  border-radius: 8px;
  overflow: hidden;
...
#header {
  padding: 10px 15px;
  background: linear-gradient(135deg, rgba(255, 255, 70, 0.6), rgba(130, 130, 0, 0.6));
  border-bottom: 1px solid rgba(255, 255, 70, 0.3);
  font-weight: bold;
  color: #fff;
  font-size: 2rem;
}
